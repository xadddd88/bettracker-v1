...
Runtime remains blocked until the PR #85 protected read-only path is merged/deployed and CPO separately approves the first read-only production odds dry-run.
