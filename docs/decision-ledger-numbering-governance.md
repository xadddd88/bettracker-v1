...
Status: Decision #064 is occupied and ACTIVE with implementation merged but migration 025 unapplied. Decision #065 is occupied and ACTIVE as Broadcast Noir Draft PR A. Decision #063 remains the highest-numbered CLOSED decision; #066 is next unreserved.
...
Occupied / active: #065 — Broadcast Noir Cross-Platform Rollout (Draft PR A; tokens/primitives/CI only)
Highest-numbered closed: #063 — Tracked-Leg Fixture Lineage Contract (docs-only)
Active approved: #065 — Broadcast Noir Cross-Platform Rollout (Draft PR A; no screens/runtime)
...
| #065 | Broadcast Noir Cross-Platform Rollout — ACTIVE / DRAFT PR A; semantic tokens/primitives and contrast/parity CI only; no screens/runtime |
...
- Founder authorized Decision #065 Broadcast Noir Draft PR A for semantic tokens/primitives and contrast/parity CI only; #066 is next unreserved.
