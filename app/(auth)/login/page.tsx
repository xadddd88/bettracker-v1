  ...
  return (
    <main className="web-editorial grid min-h-screen bg-[var(--night)] lg:grid-cols-[minmax(0,1.35fr)_minmax(420px,0.65fr)]">
      <section className="relative flex min-h-[44vh] flex-col overflow-hidden border-b border-[var(--border-strong)] bg-[var(--night)] p-5 text-[var(--text-primary)] lg:min-h-screen lg:border-b-0 lg:border-r lg:p-10">
        <div className="pointer-events-none absolute -bottom-8 -left-5 select-none font-display text-[clamp(8rem,24vw,24rem)] font-black leading-none tracking-[-0.1em] text-[var(--text-primary)] opacity-[0.055]" aria-hidden>
          BETTRACKER
        </div>
        <header className="relative z-10 flex min-h-12 items-center border-y border-[var(--border-strong)]">
          <div className="font-display text-xl font-black tracking-[-0.045em] text-[var(--text-primary)]">BETTRACKER</div>
          <div className="ml-4 flex-1 font-mono text-[11px] font-bold tracking-[0.12em] text-[var(--text-quiet)]">SHARED VISUAL SYSTEM / V3.1</div>
        ...
        <div className="relative z-10 my-auto py-12 lg:py-20">
          ...
          <h1 className="mt-6 max-w-4xl font-display text-[clamp(3.2rem,7vw,8rem)] font-black uppercase leading-[0.8] tracking-[-0.075em] text-[var(--text-primary)]">
            Evidence<br />before<br />action
          </h1>
          <p className="mt-8 max-w-md text-sm leading-6 text-[var(--text-muted)]">
            Analyze the signal. Keep every coupon leg in order. Build a record you can trust.
          </p>
        </div>
        <div className="relative z-10 grid grid-cols-3 border-y border-[var(--border-strong)] py-4 font-mono text-[11px] font-bold uppercase tracking-[0.12em] text-[var(--text-muted)]">
          <span>01 / Scan</span>
        ...
        <div className="editorial-page w-full max-w-xl lg:mx-auto">
          ...
          <div className="mt-8 grid grid-cols-3 overflow-hidden rounded-[var(--radius-control)] border border-[var(--border-strong)]">
            {MODES.map(item => (
              <button
                ...
                className={`min-h-12 border-r border-[var(--border-strong)] px-2 font-mono text-[11px] font-black uppercase tracking-[0.06em] transition-colors last:border-r-0 ${
                  mode === item.value
          ...
          {magicSent ? (
            <div className="mt-8 rounded-[var(--radius-control)] border border-[var(--success)] bg-[var(--field-raised)] p-6">
              <p className="font-mono text-[11px] font-black uppercase tracking-[0.12em] text-[var(--success)]">✓ Sent</p>
          ...
          <p className="mt-8 border-t border-[var(--border-strong)] pt-4 font-mono text-[11px] font-bold uppercase tracking-[0.1em] text-[var(--text-quiet)]">
