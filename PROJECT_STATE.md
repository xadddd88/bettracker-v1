...
- OPEN gate blocking runtime approval: founder must confirm in my.sportmonks.com that the subscription covers the Welsh Premier League (discovery targets' league) and record the plan tier; the SportMonks league ID for that league is also still unknown.
