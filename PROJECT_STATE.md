...
- Decision #038 is in review for M1.2.e.2.b.1 SportMonks Mapping Discovery Endpoint Evidence Scope.
- It must confirm official docs/account evidence for fixture date or between-date discovery without calling SportMonks.
...
- Do NOT start M1.2.e football enrichment implementation; read-only dry-run scope is done, canonical-linked runtime remains blocked on an exact/high SportMonks provider link, M1.2.e.2.b SportMonks mapping discovery scope is DONE, M1.2.e.2.b.1 endpoint evidence scope is in review, and no runtime provider call is approved
- Do NOT start i18n
