...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: colors.accent, fontFamily: 'monospace', fontSize: 9, fontWeight: '700', letterSpacing: 1.4 },
  title: { color: colors.text, fontSize: 21, fontWeight: '800', lineHeight: 27 },
  badge: { backgroundColor: colors.surfaceMuted, borderRadius: 5, borderWidth: StyleSheet.hairlineWidth, paddingHorizontal: 9, paddingVertical: 5 },
  badgeText: { fontFamily: 'monospace', fontSize: 10, fontWeight: '700' },
  card: { backgroundColor: colors.surface, borderColor: colors.border, borderRadius: 12, borderWidth: StyleSheet.hairlineWidth, gap: 13, padding: 14 },
  ...
  summaryLabel: { color: colors.muted, fontFamily: 'monospace', fontSize: 9 },
  summaryValue: { color: colors.text, fontSize: 15, fontVariant: ['tabular-nums'], fontWeight: '800', maxWidth: '100%' },
  ...
  sectionTitle: { color: colors.secondaryText, fontFamily: 'monospace', fontSize: 10, fontWeight: '700', letterSpacing: 0.7, textTransform: 'uppercase' },
  ...
  legIndex: { color: colors.magenta, fontFamily: 'monospace', fontSize: 11, fontWeight: '700' },
  ...
  legOdds: { borderColor: colors.accent, borderRadius: 5, borderWidth: StyleSheet.hairlineWidth, color: colors.accent, fontSize: 14, fontWeight: '800', minWidth: 46, paddingHorizontal: 7, paddingVertical: 5, textAlign: 'center' },
